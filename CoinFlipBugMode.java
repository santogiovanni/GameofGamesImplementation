    ...
    public static void flip(){
        ...
        for(int i = 1; i<=numRounds; i++){
            ...
            System.out.println("Round: " + i + "\n");
             ...
             //TEST MODE
             //test is used to determine the correct output of heads or tails before making the decision
             System.out.println("{TEST} Correct Answer: " + randNum+"\n");
            ...
            //BUG MODE [2]
            //result of randNum is tails, however the system reports the answer as heads, user gets a point as if the answer is heads
            if(randNum == 1){
                //results is printed
            ...
            if(userPts>target){
                ...
                //global user points will also increase continued round
            }
            if(compPts>target){
